...
const RecommendedForYou = () => {
  const recommendations = [
    ...
    },
    {
      ...
      genre: "Comedy",
      description:
        "A workplace mockumentary about the daily lives of teachers in an underfunded Philadelphia elementary school.",
          ...
          >
            ...
            <div className="relative w-20 h-28 rounded-lg overflow-hidden bg-gray-800 flex-shrink-0">
              <img
                ...
                onError={(e) => {
                  e.target.src =
                    "https://via.placeholder.com/80x112/374151/9CA3AF?text=No+Image";
                }}
              />
